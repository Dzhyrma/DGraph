...
*            {@link org.dgraph.graph.WeightedMultiGraph.WeightedMultiEdge WeightedMultiEdge&lt;V&gt;} implementation
 *
 * @author Andrii Dzhyrma
 * @since April 21, 2014 */
public class WeightedMultiGraph<V, E extends WeightedMultiGraph.WeightedMultiEdge<V>> extends
		AbstractWeightedGraph<V, E, Double> {

	public static class WeightedMultiEdge<V> extends AbstractWeightedGraph.AbstractWeightedEdge<V, Double> {
	...
	/** Creates an instance of a new weighted multigraph with edge factory. The edge
