...
*            {@link org.dgraph.graph.edge.WeightedEdge WeightedEdge&lt;V, W&gt;} interface
*
* @author Andrii Dzhyrma
* @since April 21, 2014 */
public class WeightedDirectedGraph<V, E extends WeightedEdge<V, W>, W> extends
		AbstractWeightedDirectedGraph<V, E, W> {
	...
	/** Creates an instance of a new weighted directed graph without loops and with edge factory. The edge
	...
	/** Creates an instance of a new weighted directed graph with edge factory. The edge
	 * factory will be used in the {@link #addEdge(Object, Object) addEdge(V v1, V
	 * v2)} and {@link #addEdge(Object, Object, Object) addEdge(V v1, V
	 * v2, W w)}  methods. Using another constructor, these methods will throw
	 * {@link UnsupportedOperationException}.
