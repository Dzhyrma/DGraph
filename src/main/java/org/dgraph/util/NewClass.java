...
public class NewClass {
    ...
    public static void main(String[] args) {
        final DirectedGraph<Integer, SimpleEdge<Integer>> graph =
        ...
        System.out.println(graph);
        final WeightedDirectedGraph<Integer, WeightedSimpleEdge<Integer>, Double> weightedGraph =
                new WeightedDirectedGraph<Integer, WeightedSimpleEdge<Integer>, Double>(
                        WeightedSimpleEdge::new);
        ...
        final Path<Integer, WeightedSimpleEdge<Integer>> bfs = BreadthFirstSearch.findPath(weightedGraph, 0, 4);
        System.out.println(bfs);
        final Path<Integer, WeightedSimpleEdge<Integer>> dfs = DepthFirstSearch.findPath(weightedGraph, 0, 4);
        System.out.println(dfs);
        final WeightedPath<Integer, WeightedSimpleEdge<Integer>> dijkstra =
                Dijkstra.findShortestPath(weightedGraph, 0, 4);
        System.out.println(dijkstra);
        final Map<Integer, WeightedPath<Integer, WeightedSimpleEdge<Integer>>> bellmanFord =
                BellmanFord.findAllShortestPaths(weightedGraph, 0, true);
        System.out.println(bellmanFord);
        final Map<Integer, Map<Integer, WeightedPath<Integer, WeightedSimpleEdge<Integer>>>> floydWarshall =
                FloydWarshall.findAllShortestPaths(weightedGraph);
        System.out.println(floydWarshall);
        final Map<Integer, Map<Integer, WeightedPath<Integer, WeightedSimpleEdge<Integer>>>> johnson =
